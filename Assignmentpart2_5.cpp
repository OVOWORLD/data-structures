...
MyFrame::MyFrame ( const wxString& title, const wxPoint& pos, const wxSize& size)
            : wxFrame((wxFrame *)NULL, -1, title, pos, size)
  {
    ...
    menuQueue->Append( ID_CreatePQ,   wxT("Create PQ"), wxT("Create the  Priority Queue") );
    menuQueue->Append( ID_DisplayPQ,  wxT("Display All"),  wxT("Display ALL records") );
    menuQueue->Append( ID_ShowHeadPQ, wxT("Show Head"),    wxT("Show record at head") );
    menuQueue->Append( ID_ShowTailPQ, wxT("Show Tail"),    wxT("Show record at tail") );
    menuQueue->Append( ID_DequeuePQ,  wxT("Dequeue"),      wxT("Remove record from head") );
    
    //Append the sub-menu items to the Deque Main Menu item
    menuQueue->Append( ID_CreateDeque,   wxT("Create Deque"), wxT("Create the Deque") );
    menuQueue->Append( ID_DisplayDeque,  wxT("Display All"),  wxT("Display ALL records") );
    menuQueue->Append( ID_ShowHeadDeque, wxT("Show Head"),    wxT("Show record at head") );
    menuQueue->Append( ID_ShowTailDeque, wxT("Show Tail"),    wxT("Show record at tail") );
    menuQueue->Append( ID_DequeueHeadDeque,  wxT("Dequeue Head"),      wxT("Remove record from head") );
    menuQueue->Append( ID_DequeueTailDeque,  wxT("Dequeue Tail"),      wxT("Remove record from tail") );
    menuQueue->Append( ID_EnqueueHeadDeque,  wxT("Enqueue Head"),      wxT("Add record to head") );
    menuQueue->Append( ID_EnqueueTailDeque,  wxT("Enqueue Tail"),      wxT("Add record to tail") );
    
    //Append the sub-menu items to the Stack Main Menu item
    menuQueue->Append( ID_CreateStack,   wxT("Create Stack"), wxT("Create the Stack") );
    menuQueue->Append( ID_PushStack,     wxT("Push"),       wxT("Add record to the tail") );
    menuQueue->Append( ID_PopStack,      wxT("Pop"),        wxT("Remove record from head") );
    menuQueue->Append( ID_DisplayStack,  wxT("Display All"),    wxT("Display All records") );
    menuQueue->Append( ID_ShowHeadStack, wxT("Show Head"),    wxT("Show record at Head") );
    menuQueue->Append( ID_ShowTailStack, wxT("Show Tail"),      wxT("Show record at Tail") );
    
    //Append the sub-menu items to the Help Main Menu item
    menuQueue->Append( ID_About, wxT("About"),      wxT("About Help") );
