...
MyFrame::MyFrame ( const wxString& title, const wxPoint& pos, const wxSize& size)
            : wxFrame((wxFrame *)NULL, -1, title, pos, size)
  {
    ...
    //Append the sub-menu items to the BST Tree Main Menu item
     ...
     menuBST->Append( ID_PreOrderBST,   wxT("PreOrder"), wxT("PreOrder Traversal") );
     menuBST->Append( ID_PostOrderBST,   wxT("PostOrder"), wxT("PostOrder Traversal") );
     menuBST->Append( ID_InOrderBST,   wxT("InOrder"), wxT("InOrder Traversal") );
