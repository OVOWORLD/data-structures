...
class MyFrame: public wxFrame
  {
	...
	void OnRemoveBST(wxCommandEvent& event);
	...
	void OnRemoveAVL(wxCommandEvent& event);
...
BEGIN_EVENT_TABLE ( MyFrame, wxFrame )
     ...
     EVT_MENU ( ID_RemoveBST,    MyFrame::OnRemoveBST)
     ...
     EVT_MENU ( ID_RemoveAVL,    MyFrame::OnRemoveAVL)
...
MyFrame::MyFrame ( const wxString& title, const wxPoint& pos, const wxSize& size)
            : wxFrame((wxFrame *)NULL, -1, title, pos, size)
  {
    ...
    //Append the sub-menu items to the BST Tree Main Menu item
     menuBST->Append( ID_CreateBST,   wxT("Create BST Tree"), wxT("Create the BST Tree") );
     menuBST->Append( ID_RemoveBST,   wxT("Remove BST Tree"), wxT("Remove the BST Tree") );
     ...
     menuAVL->Append( ID_CreateAVL,   wxT("Create AVL Tree"), wxT("Create the BST Tree") );
     menuAVL->Append( ID_RemoveAVL,   wxT("Remove AVL Tree"), wxT("Remove the BST Tree") );
...
void MyFrame::OnRemoveBST(wxCommandEvent& event)
{
...
void MyFrame::OnRemoveAVL(wxCommandEvent& event)
{
