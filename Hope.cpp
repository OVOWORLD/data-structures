...
AVLTree* AVLList = new AVLTree();
RBTree* RBTList = new RBTree();
SplayTree* STList = new SplayTree();
BinaryHeap* BHList = new BinaryHeap();
Set* AList = new Set();
Set* BList = new Set();
Set* CList = new Set();
        ...
        while (!infile.eof())
            {
                ...
                if (!infile.eof())
			      ...
			      record = makeRecord(rankNo, player,team, totRuns, oppTeam, yr);
                                ...
                                record.append("\t\t...Enqueued\n");
                                dList->insertFirst(rankNo, player, team, totRuns, oppTeam, yr);
                            }
			      ...
			      record = makeRecord(rankNo, player,team, totRuns, oppTeam, yr);
                                ...
                                record.append("\t\t...Enqueued\n");
                                dList->insertLast(rankNo, player, team, totRuns, oppTeam, yr);
			    }
...
void MyFrame::OnDequeueHeadDeque(wxCommandEvent& event)
{
  // Clear the edit box
      ...
      string record = dList->removeFirst();
...
void MyFrame::OnDequeueTailDeque(wxCommandEvent& event)
{
  // Clear the edit box
      ...
      string record = dList->removeLast();
                        ...
                        if(strstr(team.c_str(), "Australia"))
                            {
                                ...
                                record.append("\t\t...Inserted\n");
                                AVLList->insert(rankNo,player,team, totRuns, oppTeam, yr);
                            }
                        ...
                        if(strstr(team.c_str(), "South Africa"))
                            {
                                ...
                                record.append("\t\t...Inserted\n");
                                BHList->addMinHeap(rankNo,player,team, totRuns, oppTeam, yr);
                            }
                        ...
                        if(strstr(team.c_str(), "England"))
                            {
                                ...
                                record.append("\t\t...Inserted\n");
                                RBTList->insert(rankNo, player,team, totRuns, oppTeam, yr);
                            }
                        ...
                        if(strstr(team.c_str(), "India") || strstr(team.c_str(), "Pakistan"))
                            {
                                ...
                                record.append("\t\t...Inserted\n");
                                STList->insert(rankNo, player,team, totRuns, oppTeam, yr);
                            }
                ...
                if (!infile.eof())
                    {
                        ...
                        if(strstr(team.c_str(), "West Indies") && (yr < 1981))
                            {
                                ...
                                record.append("\t\t...Inserted\n");
                                AList->add(rankNo, player,team, totRuns, oppTeam, yr);
                            }
                        ...
                        record = "";
                    ...
                    else if (strstr(team.c_str(), "West Indies") && (yr > 1980))
                            {
                                ...
                                record.append("\t\t...Inserted\n");
                                BList->add(rankNo,player,team, totRuns, oppTeam, yr);
